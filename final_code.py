...
known_face_encodings = [img_061_encoding, img_085_encoding, img_092_encoding, img_098_encoding]
...
known_face_names = ["Prashanth SK", "SHUBHAM KUMAR", "SUMUKHA VASISHTA","THEERTHANA SR",]
