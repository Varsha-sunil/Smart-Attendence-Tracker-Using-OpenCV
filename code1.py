...
known_face_encodings = [img_061_encoding, img_065_encoding,img_079_encoding, img_081_encoding, img_083_encoding,img_092_encoding]

## known_face_names = [img061
...
known_face_names = ["Prashanth SK","RADHAKRISHNA","SHASHANK KASHYAP","SHREYAMS DK","SHREYAS GOWDA", "SUMUKHA VASISHTA",]
