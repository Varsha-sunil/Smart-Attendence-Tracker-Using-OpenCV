...
known_face_encodings = [img_061_encoding, img_069_encoding, img_085_encoding,img_092_encoding]
...
known_face_names = ["Prashanth SK","ROHAN KR", "SHUBHAM KUMAR", "SUMUKHA VASISHTA"]
